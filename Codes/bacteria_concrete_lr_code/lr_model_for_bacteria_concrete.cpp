...
{  
    fstream op;
    op.open("input_for_bacteria.txt",ios::in);
    int n;
    double k;
    op >> n;
    vector<double> y1(n);
  ...
  fstream out ;
  out.open("output_for_bacteria.txt",ios::out);
  vector<vector<double>> A1;
    ...
    vector <double> sol1= gauss(A1,b1);
     out << "The constants for modified Saenz Model determined by multilinear model for Bacteria concrete:- " << endl;
